...
The Neario type stack — drop the following `.ttf` files into this directory before the first run. All three families ship under the SIL Open Font License (OFL).
